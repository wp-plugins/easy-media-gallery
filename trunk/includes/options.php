...
array( "name" => "Columns",
	"desc" => "Select default Column for each media block, you can also set this manually when adding shortcode.<br><br><a target='_blank' href='http://ghozylab.com/pro-version/'>Upgrade</a> to PRO and you can choose up to 8 columns.",
...
array( "name" => "Alignment",
	"desc" => "Select image block or single image alignment. Default: Center<br><br><a target='_blank' href='http://ghozylab.com/pro-version/'>Upgrade</a> to PRO and you can choose center, left or right alignment.",
...
array( "name" => "Media Box Style",
	"desc" => "Select media box style. Default: Light<br><br><a target='_blank' href='http://ghozylab.com/pro-version/'>Upgrade</a> to PRO and get more styles.",

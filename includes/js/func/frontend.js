...
/* Version 1.1.3 */
jQuery(function(){jQuery(window).scroll(function(){if(jQuery("#mbCenter").size()>0){var e=parseInt(jQuery(document).scrollTop());var t=jQuery("#mbCenter").offset();var n=parseInt(t.top+jQuery("#mbCenter").height()+340-e);var r=jQuery(window).height()-n;if(e<t.top-200){setTimeout(function(){jQuery("#mbCenter").stop().animate({top:jQuery(window).scrollTop()+340},500)},150)}if(r>1&&jQuery(window).height()<jQuery("#mbCenter").height()-250){setTimeout(function(){jQuery("#mbCenter").stop().animate({top:t.top+r},500)},150)}else if(r>1&&jQuery(window).height()>jQuery("#mbCenter").height()+250){setTimeout(function(){jQuery("#mbCenter").stop().animate({top:jQuery(window).scrollTop()+340},500)},150)}}})})

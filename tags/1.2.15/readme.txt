...
Tags: gallery, wordpress gallery plugin, portfolio wordpress plugin, grid portfolio, gallery wordpress plugin, widget, portfolio gallery, grid gallery, photo albums, wordpress portfolio plugin, filterable portfolio, filterable gallery, best gallery plugin, image album, admin, plugin, portfolio, html5 mp4, post, page, admin, posts, images
...
= Full media support =
<p>Easy Media Gallery satisfy all your needs letting you create different types of portfolio or gallery. Each item can be:</p> 

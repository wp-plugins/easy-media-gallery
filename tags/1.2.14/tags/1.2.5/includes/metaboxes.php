...
function easmedia_metabox_work(){
		...
		'description' => __( 'Select videos, images, gallery or audio files.<br><br><span style="color:#F00;">Upgrade to PRO and you can select Image Gallery, Grid Gallery, HTML5 Video/Audio, Google Maps/Street View, embed from Soundcloud or Reverbnation and also Link to specific URL. You can learn more and see version comparison <a href="edit.php?post_type=easymediagallery&page=comparison">HERE</a></span>', 'easmedia' ),

...
array( "name" => "Audio Auto Play",
	"desc" => "Use this to enable/disable audio auto play. This feature only work for media MP3.",
	"id" => $theshort."_disen_autopl",
	"type" => "checkbox",
	"std" => "1"),	
	
array( "name" => "Audio Loop",
	"desc" => "Use this to enable/disable audio loop. This feature only work for media MP3.",
...
array( "name" => "Thumbnail Border Color",
	"desc" => "Define your custom Border Color. Default color is white (#FFF)",
	"id" => $theshort."_frm_col",
	"type" => "color",
	"std" => "#FFFFFF"),	
	
array( "name" => "Thumbnail Title Color",
	"desc" => "Define your Title Color. Default color is dark grey",
